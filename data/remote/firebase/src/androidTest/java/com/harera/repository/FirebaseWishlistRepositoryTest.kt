...
class FirebaseWishlistRepositoryTest {
    ...
    @Inject
    lateinit var wishListRepository: com.harera.repository.abstraction.WishListRepository

    @Inject
    lateinit var authManager : com.harera.repository.abstraction.AuthManager
