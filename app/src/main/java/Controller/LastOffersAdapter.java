...
public class LastOffersAdapter extends RecyclerView.Adapter<LastOffersAdapter.ViewHolder> {
    private List<LastOffer> offers;
    private Context context;

    public LastOffersAdapter(List<LastOffer> list, Context context) {
        this.offers = list;
