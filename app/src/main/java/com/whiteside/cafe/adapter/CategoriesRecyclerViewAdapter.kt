...
import com.whiteside.cafe.ui.category.CategoryProducts
...
class CategoriesRecyclerViewAdapter(private val context: Context?) :
    ...
    init {
        categoryName = context!!.resources.getStringArray(R.array.categories)
        categoryDrawable = context.resources.obtainTypedArray(R.array.categories_drawables)
    }
}