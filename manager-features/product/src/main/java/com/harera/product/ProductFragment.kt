...
class ProductFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        productsAdapter =
            ProductsAdapter(navController = findNavController(), products = emptyList())
    ...
    private fun setupListener() {
        ...
        bind.edit.setOnClickListener {
            findNavController().navigate(
                Uri.parse(NavigationUtils.getUriNavigation(HYPER_PANDA_DOMAIN, Destinations.EDIT_PRODUCT, productViewModel.productId.value!!))
            )
        }
    }
}